...
typedef struct {
    ...
    gmx_bool bSliceSmooth; /**< Smooth sliced group weighting */
    real     slice_x_min;  /**< Min of the slice interval in x coordinate */
    real     slice_x_max;  /**< Max of the slice interval in x coordinate */
} t_pull_group;
